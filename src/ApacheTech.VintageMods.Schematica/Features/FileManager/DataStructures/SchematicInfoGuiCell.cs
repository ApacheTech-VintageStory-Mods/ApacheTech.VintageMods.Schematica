...
namespace ApacheTech.VintageMods.Schematica.Features.FileManager.DataStructures
{
    ...
    public class SchematicInfoGuiCell : GuiElementTextBase, IGuiElementCell
    {
        ...
        /// <summary>
        /// 	Initialises a new instance of the <see cref="SchematicInfoGuiCell" /> class.
        /// </summary>
        /// <param name="capi">The capi.</param>
        /// <param name="cell">The cell.</param>
        /// <param name="bounds">The bounds.</param>
        public SchematicInfoGuiCell(ICoreClientAPI capi, SchematicInfoCellEntry cell, ElementBounds bounds) : base(capi, "", null, bounds)
        {
            Cell = cell;
            Bounds = bounds;
        ...
        public SchematicInfoCellEntry Cell { get; }
